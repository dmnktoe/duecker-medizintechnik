...
const defaultMeta = {
  title: 'Ihr Partner für OP-Lösungen und Sterilisierungen',
...
export default function Seo(props: SeoProps) {
  ...
  // If there is a SEO-optimized meta.seo.title use this, otherwise use
  // the templateTitle generated by the pageTitle and from siteName
