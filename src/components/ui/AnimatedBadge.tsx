...
export const AnimatedBadge = ({ text }: { text: string }) => {
  return (
    <span className='group relative mb-6 inline-block rounded-full bg-dark p-px text-xs font-semibold leading-6 text-white no-underline  shadow-2xl shadow-zinc-900'>
