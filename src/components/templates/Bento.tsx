...
const tiles = [
  ...
  },
  {
    ...
    background: (
      <Globe className='top-0 h-[600px] w-[600px] opacity-60 transition-all duration-300 ease-out [mask-image:linear-gradient(to_top,transparent_30%,#000_100%)] sm:left-40' />
    ),
  },
];
