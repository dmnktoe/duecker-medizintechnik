          ...
          >
            ...
            <section id='privacy-section-2'>
              ...
              <Body>
                ...
                Person beziehen. Hierzu zählen z.B. Ihr Name, Ihre Adress- und
              ...
              <Body>
                ...
                Geschäftspartner und sonstige Besucher unserer Webseite.
              </Body>
              <Body>
                ...
                Begrifflichkeiten wie z.B. „Nutzer“ sind geschlechtsneutral zu
                verstehen.
              </Body>
              <Body>&nbsp;</Body>
            </section>
            <section id='privacy-section-3'>
              ...
              <Body>
                Vertreter des Verantwortlichen ist der Datenschutzbeauftragte
                Marc Dücker.
              </Body>
              <Body>&nbsp;</Body>
            </section>
            ...
            <section id='privacy-section-5'>
              ...
              <Body>
                ...
                oder Erziehungsberechtigten unsere Webseiten nicht nutzen und
                keine personenbezogenen Daten an uns übermitteln. Wir sammeln
                daher wissentlich keine personenbezogenen Daten von
            ...
            <section id='privacy-section-6'>
              ...
              <Body>
                ...
                für die Dauer von maximal sieben Tagen gespeichert und danach
              ...
              <Body>
                ...
                Daten. Die sonstigen während des Absendevorgangs verarbeiteten
                personenbezogenen Daten (z.B. IP-Adresse, Datum, Uhrzeit) dienen
              ...
              <Body>
                ...
                widersprechen. In diesem Fall kann unsere Konversation natürlich
                nicht mehr fortgeführt werden. Einen solchen Widerruf richten
                Sie bitte an{' '}
                <UnderlineLink href={'mailto:' + company.email}>
                  {company.email}
                </UnderlineLink>
              ...
              <Body>
                ...
                Art. 6 Abs. 1 lit. b) DSGVO, um unsere vertraglichen oder
              ...
              <Body>
                ...
                wir, sofern erforderlich, gem. Art. 6 Abs. 1 lit. a., Art. 7,
                Art. 9 Abs. 2 lit. a. DSGVO eine ausdrückliche Einwilligung der
                Patienten ein und verarbeiten die besonderen Kategorien von
                Daten ansonsten zu Zwecken der Gesundheitsvorsorge auf Grundlage
                des Art. 9 Abs. 2 lit h. DSGVO, § 22 Abs. 1 Nr. 1 b. BDSG.
              </Body>
              <Body>
              ...
              <Body>
                ...
                Rahmen der Kommunikation mit medizinischen Fachkräften, an der
                ...
                Interessen oder denen der Patienten an einer effizienten und
                ...
                Patienten oder einer anderen natürlichen Person zu schützen oder
              ...
              <Body>
                ...
                Löschung keine gesetzlichen Fürsorgepflichten,
                Aufbewahrungspflichten sowie etwaigen Gewährleistungs- und
                vergleichbaren Pflichten entgegenstehen. Aufbewahrungspflichten
                ergeben sich aus handels- und steuerrechtlichen Gründen. Nach
                gesetzlichen Vorgaben erfolgt die Aufbewahrung für 6 Jahre gemäß
                § 257 Abs. 1 HGB (Handelsbriefe, Buchungsbelege.) sowie für 10
                Jahre gemäß § 147 Abs. 1 AO (z.B. Buchungsbelege, Handels- und
              ...
              <Body>
                ...
                Menüpunkt „Karriere“ werden bei Verfügbarkeit Stellenangebote
                ausgeschrieben. Sie können sich auch initiativ bewerben. Wenn
                Sie sich per E-Mail bei uns bewerben, verarbeiten wir die Daten,
              ...
              <Body>
                ...
                Rechtsverfolgung erforderlich sein, kann eine Datenverarbeitung
                auf Basis der Voraussetzungen von Art. 6 DSGVO, insbesondere zur
                Wahrnehmung von berechtigten Interessen nach Art. 6 Abs. 1 lit.
              ...
              <Body>
                ...
                Position weitergeleitet. Dann wird der weitere Ablauf
                abgestimmt. Im Unternehmen haben grundsätzlich nur die Personen
              ...
              <Body>
                ...
                werden diese Daten unter Berücksichtigung der Klagefrist des AGG
                3 Monate nach Beendigung des Bewerbungsverfahrens gelöscht, es
                sei denn, der Bewerber hat eine Einwilligung nach Art. 6 Abs. 1
                lit a) DSGVO und Art. 7 DSGVO zur längerfristigen Aufbewahrung
              ...
              <Body>
                ...
                gespeichert werden. Cookies richten auf Ihrem Computer keinen
                Schaden an und enthalten keine Schadsoftware wie z.B. Viren.
                Cookies enthalten eine charakteristische Zeichenfolge, die eine
                eindeutige Identifizierung des Browsers beim erneuten Aufrufen
                der Website ermöglicht. Einige Elemente unserer Website
                erfordern es, dass der aufrufende Browser auch nach einem
              ...
              <Body>
                ...
                Ihrem Namen, Ihrer IP-Adresse oder mit ähnlichen Daten, die eine
                Zuordnung des Cookies zu Ihnen ermöglichen würden, erfolgt
                nicht.
              </Body>
              <Body>
              ...
              <Body>
                ...
                Sitzung zuordnen lassen. Wenn Sie auf unsere Website
                zurückkehren, kann Ihr Rechner wiedererkannt werden. Die
                Session-Cookies werden gelöscht, wenn Sie sich ausloggen bzw.
              ...
              <Body>
                ...
                gar nicht gespeichert oder am Ende Ihrer Internetsitzung
                automatisch gelöscht werden. Hierzu wählen sie in den
                Einstellungen Ihres Browsers „keine Cookies akzeptieren“. Im
                Microsoft Internet-Explorer wählen Sie hierzu „Extras &gt;
              ...
              <Body>
                ...
                Website. Hierfür verwenden wir u.a. Cookies. Was Cookies sind
                und wie diese gelöscht werden können, haben wir oben im Kapitel
                „Cookies“ beschrieben.
              </Body>
              <Body>
                Die dabei von Google erhobenen Informationen über Ihre Nutzung
                dieser Website (z.B. die bei uns besuchte Seiten) werden an
                einen Server von Google in die USA übertragen, dort gespeichert,
              ...
              <Body>
                ...
                ihrer Browser-Software verhindern, wie oben im Kapitel „cookies“
                beschrieben. Sie können darüber hinaus die Erfassung der durch
                das Cookie erzeugten und auf ihre Nutzung unserer Website
                bezogenen Daten an Google sowie die Verarbeitung dieser Daten
                durch Google verhindern, indem sie das verfügbare Browser-Plugin
            ...
            <section id='privacy-section-7'>
              ...
              <Body>
                ...
                Stand der Technik. Damit stellen wir sicher, dass die
                Vorschriften der Datenschutzgesetze, insbesondere der
                Datenschutz-Grundverordnung, eingehalten werden und die durch
                uns verarbeiteten Daten gegen Vernichtung, Verlust, Veränderung
                und unberechtigte Zugriffe geschützt sind. Zu diesen
                Sicherheitsmaßnahmen zählt auch die verschlüsselte Übertragung
                von Daten zwischen Ihrem Browser und unseren Servern. Bitte
                beachten Sie, dass die SSL-Verschlüsselung bei über das Internet
                ...
                erscheint und die Adresse mit https:// beginnt. Durch SSL
                (Secure Socket Layer) wird die Datenübertragung mit einer
                Verschlüsselungstechnologie vor illegalem Datenzugriff Dritter
                geschützt. Sollte diese Option nicht zur Verfügung stehen,
                können Sie sich auch dafür entscheiden, bestimmte Daten nicht
                über das Internet zu versenden.
              </Body>
              <Body>
                Alle Informationen, die Sie an uns übermitteln, werden auf
                unseren Servern in der Bundesrepublik Deutschland gespeichert
                und verarbeitet.
              </Body>
              <Body>&nbsp;</Body>
            </section>
            <section id='privacy-section-8'>
              ...
              <Body>
                ...
                gesetzliche verpflichtet sind (Art. 6 Abs.1 lit. c) DSGVO oder
                auf Grundlage berechtigter Interessen gem. Art. 6 Abs. 1 lit. f.
                DSGVO am wirtschaftlichen und effektivem Betrieb unseres
                Geschäftsbetriebes.
              </Body>
              <Body>
                Wir setzen im Rahmen einer Auftragsverarbeitung gem. Art. 28
                DSGVO Subunternehmer für die Erbringung unserer Leistungen,
                insbesondere für den Betrieb, die Wartung und das Hosting der
                Website ein. Wir haben geeignete rechtliche Vorkehrungen sowie
                entsprechende technische und organisatorische Maßnahmen
                getroffen, um für den Schutz der personenbezogenen Daten gemäß
            ...
            <section id='privacy-section-9'>
              ...
              <Body>
                ...
                Dies erfolgt auf Grundlage unserer berechtigten Interessen an
                der Analyse, Optimierung und wirtschaftlichen Betrieb unsers
              ...
              <Body>
                ...
                Inhalten in Ihrem Browser erforderlich ist. Weitere
                Informationen über Zweck und Umfang der Erhebung und
                Verarbeitung Ihrer Daten entnehmen Sie daher bitte den
                Datenschutzhinweisen der jeweils datenschutzrechtlich
                verantwortlichen Anbieter der von uns eingebundenen Dienste bzw.
                Inhalte. Die nachfolgende Aufzählung bietet eine Übersicht von
                Drittanbietern sowie ihrer Inhalte und Links zu deren
                Datenschutzerklärungen, die weitere Hinweise zur Verarbeitung
                von Daten und Widerspruchsmöglichkeiten enthalten.
              </Body>
              <ul>
                <li>
                ...
                <li>
                  ...
                  Webseiten, etc.). Angeboten von: Google Inc., 1600
                  Amphitheatre Parkway, Mountain View, CA 94043, USA.
                  Datenschutzerklärung:{' '}
                ...
                <li>
                  ...
                  Anzeigen (sog. Facebook-Ads). Angeboten von: Facebook Inc., 1
                  Hacker Way, Menlo Park, CA 94025, USA, bzw. innerhalb der EU:
                ...
                <li>
                  ...
                  Angeboten von: Vimeo Inc., Attention: Legal Department, 555
                ...
                <li>
                  ...
                  Spam-Kommentaren. Angeboten von: Automattic Inc., 60 29th
                  Street #343, San Francisco, CA 94110, USA. Informationen zur
                  Erhebung und Nutzung der Daten durch Akismet finden sich in
                  den Datenschutzhinweisen von Automattic:{' '}
            ...
            <section id='privacy-section-10'>
              ...
              <Body>
                ...
                Twitter, Instagram, XING, Linkedin, Pinterest, tumblr und
                Google+.
              </Body>
              <Body>
              ...
              <Body>
                ...
                von Ihnen an den jeweiligen Plug-in-Anbieter übermittelt und
                dort (bei US-amerikanischen Anbietern in den USA) gespeichert.
                Da der Plug-in-Anbieter die Datenerhebung insbesondere über
                Cookies vornimmt, empfehlen wir Ihnen, vor dem Klick auf den
                ausgegrauten Kasten über die Sicherheitseinstellungen Ihres
              ...
              <Body>
                ...
                Plug-in-Anbieter wenden müssen. Über die Plug-ins bieten wir
                Ihnen die Möglichkeit, mit den sozialen Netzwerken und anderen
                Nutzern zu interagieren, so dass wir unser Angebot verbessern
                und für Sie als Nutzer interessanter ausgestalten können.
                Rechtsgrundlage für die Nutzung der Plug-ins ist Art. 6 Abs. 1
                lit. f) DS-GVO.
              </Body>
              <Body>
                Die Datenweitergabe erfolgt unabhängig davon, ob Sie ein Konto
                bei dem Plug-in-Anbieter besitzen und dort eingeloggt sind. Wenn
                Sie bei dem Plug-in-Anbieter eingeloggt sind, werden Ihre bei
                uns erhobenen Daten direkt Ihrem beim Plug-in-Anbieter
                bestehenden Konto zugeordnet. Wenn Sie den aktivierten Button
                betätigen und z. B. die Seite verlinken, speichert der
                Plug-in-Anbieter auch diese Information in Ihrem Nutzerkonto und
                teilt sie Ihren Kontakten öffentlich mit. Wir empfehlen Ihnen,
                sich nach Nutzung eines sozialen Netzwerks regelmäßig
                auszuloggen, insbesondere jedoch vor Aktivierung des Buttons, da
                Sie so eine Zuordnung zu Ihrem Profil bei dem Plug-in-Anbieter
                vermeiden können.
              </Body>
              <Body>
            ...
            <section id='privacy-section-12'>
              ...
              <Body>
                ...
                der Datenverarbeitung anzupassen. Dies gilt jedoch nur im
