          ...
          >
            <nav>
              <ul className='flex list-none flex-col gap-1 text-sm'>
                <li>
                  <a href='#privacy-section-1'>1. Geltungsbereich</a>
                </li>
                <li>
                  <a href='#privacy-section-2'>
                    2. Erläuterungen der verwendeten Begriffe
                  </a>
                </li>
                <li>
                  <a href='#privacy-section-3'>
                    3. Name und Anschrift des Verantwortlichen
                  </a>
                </li>
                <li>
                  <a href='#privacy-section-4'>4. Datenschutzbeauftragter</a>
                </li>
                <li>
                  <a href='#privacy-section-5'>5. Minderjährige</a>
                </li>
                <li>
                  <a href='#privacy-section-6'>
                    6. Verarbeitung personenbezogener Daten
                  </a>
                </li>
                <li>
                  <a href='#privacy-section-7'>7. Datensicherheit</a>
                </li>
                <li>
                  <a href='#privacy-section-8'>
                    8. Weitergabe von Daten an Dritte
                  </a>
                </li>
                <li>
                  <a href='#privacy-section-9'>
                    9. Externe Inhalte und Dienste
                  </a>
                </li>
                <li>
                  <a href='#privacy-section-10'>10. Social Plugins</a>
                </li>
                <li>
                  <a href='#privacy-section-11'>11. Ihre Rechte</a>
                </li>
                <li>
              ...
              >
                <section id='privacy-section-1'>
                  ...
                  <Body>
                    ...
                    Umfang und Zwecke der Erhebung, Verwendung sowie
                    Verarbeitung personenbezogener Daten durch den
                    verantwortlichen Anbieter {company.companyName},{' '}
                  ...
                  <Body>
                    ...
                    der Datenschutzgrundverordnung (DSGVO) im
                ...
                <section id='privacy-section-2'>
                  ...
                  <Body>
                    <em>Personenbezogene Daten</em> sind alle Informationen, die
                    sich auf eine identifizierte oder identifizierbare
                    natürliche Person beziehen. Hierzu zählen z.B. Ihr Name,
                    Ihre Adress- und Kommunikationsdaten oder Ihre
                    E-Mailadresse.
                  </Body>
                  <Body>
                  ...
                  <Body>
                    <em>Nutzer</em> umfasst alle Kategorien von der
                    Datenverarbeitung betroffener Personen. Zu ihnen gehören
                    unsere Geschäftspartner und sonstige Besucher unserer
                    Webseite.
                  </Body>
                  <Body>
                    Bei den verwendeten Begrifflichkeiten verweisen wir darüber
                    hinaus auf die Definitionen in Art. 4 der
                    Datenschutzgrundverordnung (DSGVO). Die verwendeten
                    Begrifflichkeiten wie z.B. „Nutzer“ sind geschlechtsneutral
                    zu verstehen.
                  </Body>
                  <Body>&nbsp;</Body>
                </section>
                <section id='privacy-section-3'>
                  ...
                  <Body>Geschäftsführer: {company.ceo}</Body>
                  <Body margin={false}>Tel.: {company.phone}</Body>
                  <Body>
                    E-Mail:{' '}
                    <UnderlineLink href={'mailto:' + company.email}>
                      {company.email}
                  ...
                  <Body>
                    Vertreter des Verantwortlichen ist der
                    Datenschutzbeauftragte Marc Dücker.
                  </Body>
                  <Body>&nbsp;</Body>
                </section>
                <section id='privacy-section-4'>
                  ...
                  <Body>
                    Sie können unseren Datenschutzbeauftragten über die
                    E-Mailadresse{' '}
                    <UnderlineLink href={'mailto:' + company.email}>
                      {company.email}
                    </UnderlineLink>{' '}
                ...
                <section id='privacy-section-5'>
                  ...
                  <Body>
                    Personen unter 18 Jahren dürfen ohne Zustimmung ihrer Eltern
                    oder Erziehungsberechtigten unsere Webseiten nicht nutzen
                    und keine personenbezogenen Daten an uns übermitteln. Wir
                    sammeln daher wissentlich keine personenbezogenen Daten von
                    Minderjährigen. Wenn wir erkennen, dass Minderjährige ohne
                    Zustimmung über unsere Webseiten personenbezogenen Daten
                    eingeben oder über diese personenbezogenen Daten eingegeben
                    werden, löschen wir diese Daten unverzüglich.
                  </Body>
                  <Body>&nbsp;</Body>
                </section>
                <section id='privacy-section-6'>
                  ...
                  <Body>
                    ...
                    Dabei handelt es sich um folgende Daten (sogenannte
                    Serverlogfiles):
                  </Body>
                  <ul>
                    <li>IP-Adresse</li>
                  ...
                  <Body>
                    ...
                    dienen uns zur Optimierung der Website und zur
                  ...
                  <Body>
                    ...
                    Betrugshandlungen) für die Dauer von maximal sieben Tagen
                  ...
                  <Body>
                    ...
                    E-Mailadresse*, Betreff*, Thema, Ihre Nachricht. Die mit *
                    gekennzeichneten Felder sind Pflichtfelder.
                  </Body>
                  <Body>
                    Alternativ ist eine Kontaktaufnahme über von uns – je nach
                    Anliegen – zur Verfügung gestellten E-Mailadressen möglich.
                    In diesen Fällen werden die mit der E-Mail übermittelten
                  ...
                  <Body>
                    ...
                    Im Falle einer Kontaktaufnahme per E-Mail liegt hieran auch
                    das erforderliche berechtigte Interesse an der Verarbeitung
                    der Daten. Die sonstigen während des Absendevorgangs
                    verarbeiteten personenbezogenen Daten (z.B. IP-Adresse,
                    Datum, Uhrzeit) dienen dazu, einen Missbrauch des
                  ...
                  <Body>
                    ...
                    erforderlich sind. Für die personenbezogenen Daten aus der
                    Eingabemaske des Kontaktformulars und diejenigen, die per
                    E-Mail übersandt wurden, ist dies dann der Fall, wenn die
                    jeweilige Konversation mit dem Nutzer beendet ist. Beendet
                    ist die Konversation dann, wenn sich aus den Umständen
                  ...
                  <Body>
                    ...
                    Speicherung Ihrer personenbezogener Daten jederzeit
                    widersprechen. In diesem Fall kann unsere Konversation
                    natürlich nicht mehr fortgeführt werden. Einen solchen
                  ...
                  <Body>
                    ...
                    unsere vertraglichen oder vorvertraglichen Leistungen zu
                    erbringen. Die hierbei verarbeiteten Daten, die Art, der
                    Umfang und der Zweck und die Erforderlichkeit ihrer
                    Verarbeitung, bestimmen sich nach dem zugrundeliegenden
                    Vertragsverhältnis. Zu den verarbeiteten Daten gehören
                    grundsätzlich Bestands- und Stammdaten der Patienten (z.B.,
                    Name, Adresse, etc.), als auch die Kontaktdaten (z.B.,
                    E-Mailadresse, Telefon, etc.), die Vertragsdaten (z.B., in
                    Anspruch genommene Leistungen, erworbene Produkte, Kosten,
                  ...
                  <Body>
                    ...
                    Kategorien von Daten gem. Art. 9 Abs. 1 DSGVO, hier
                    insbesondere Angaben zur Gesundheit der Patienten,
                    verarbeiten. Hierzu holen wir, sofern erforderlich, gem.
                    Art. 6 Abs. 1 lit. a., Art. 7, Art. 9 Abs. 2 lit. a. DSGVO
                    eine ausdrückliche Einwilligung der Patienten ein und
                    verarbeiten die besonderen Kategorien von Daten ansonsten zu
                    Zwecken der Gesundheitsvorsorge auf Grundlage des Art. 9
                  ...
                  <Body>
                    ...
                    Patienten im Rahmen der Kommunikation mit medizinischen
                    Fachkräften, an der Vertragserfüllung erforderlicherweise
                    oder typischerweise beteiligten Dritten, wie z.B. Labore,
                    Abrechnungsstellen oder vergleichbare Dienstleister, sofern
                    dies der Erbringung unserer Leistungen gem. Art. 6 Abs. 1
                    lit b. DSGVO dient, gesetzlich gem. Art. 6 Abs. 1 lit c.
                    DSGVO vorgeschrieben ist, unseren Interessen oder denen der
                    Patienten an einer effizienten und kostengünstigen
                    Gesundheitsversorgung als berechtigtes Interesse gem. Art. 6
                    Abs. 1 lit f. DSGVO dient oder gem. Art. 6 Abs. 1 lit d.
                    DSGVO notwendig ist, um lebenswichtige Interessen der
                    Patienten oder einer anderen natürlichen Person zu schützen
                  ...
                  <Body>
                    ...
                    der Löschung keine gesetzlichen Fürsorgepflichten,
                    Aufbewahrungspflichten sowie etwaigen Gewährleistungs- und
                    vergleichbaren Pflichten entgegenstehen.
                    Aufbewahrungspflichten ergeben sich aus handels- und
                    steuerrechtlichen Gründen. Nach gesetzlichen Vorgaben
                    erfolgt die Aufbewahrung für 6 Jahre gemäß § 257 Abs. 1 HGB
                    (Handelsbriefe, Buchungsbelege.) sowie für 10 Jahre gemäß §
                    147 Abs. 1 AO (z.B. Buchungsbelege, Handels- und
                    Geschäftsbriefe, für Besteuerung relevante Unterlagen). Die
                  ...
                  <Body>
                    ...
                    Unter dem Menüpunkt „Karriere“ werden bei Verfügbarkeit
                    Stellenangebote ausgeschrieben. Sie können sich auch
                    initiativ bewerben. Wenn Sie sich per E-Mail bei uns
                  ...
                  <Body>
                    ...
                    Stelle (oder ggf. andere offene Positionen in unseren
                  ...
                  <Body>
                    ...
                    Beschäftigungsverhältnisses erforderlich sind. Sollten die
                    Daten nach Abschluss des Bewerbungsverfahrens ggf. zur
                    Rechtsverfolgung erforderlich sein, kann eine
                    Datenverarbeitung auf Basis der Voraussetzungen von Art. 6
                    DSGVO, insbesondere zur Wahrnehmung von berechtigten
                    Interessen nach Art. 6 Abs. 1 lit. f) DSGVO erfolgen. Unser
                  ...
                  <Body>
                    ...
                    werden dann intern an die Abteilungsverantwortlichen für die
                    jeweils offene Position weitergeleitet. Dann wird der
                    weitere Ablauf abgestimmt. Im Unternehmen haben
                    grundsätzlich nur die Personen Zugriff auf Ihre Daten, die
                  ...
                  <Body>
                    ...
                    werden diese Daten unter Berücksichtigung der Klagefrist des
                    AGG 3 Monate nach Beendigung des Bewerbungsverfahrens
                    gelöscht, es sei denn, der Bewerber hat eine Einwilligung
                    nach Art. 6 Abs. 1 lit a) DSGVO und Art. 7 DSGVO zur
                    längerfristigen Aufbewahrung seiner personenbezogenen Daten
                  ...
                  <Body>
                    ...
                    Bewerbungsverfahren um eine konkrete Position bei uns
                    beworben haben. In diesem Fall speichern wir die von Ihnen
                  ...
                  <Body>
                    ...
                    Rechner gespeichert werden. Cookies richten auf Ihrem
                    Computer keinen Schaden an und enthalten keine Schadsoftware
                    wie z.B. Viren. Cookies enthalten eine charakteristische
                    Zeichenfolge, die eine eindeutige Identifizierung des
                    Browsers beim erneuten Aufrufen der Website ermöglicht.
                    Einige Elemente unserer Website erfordern es, dass der
                    aufrufende Browser auch nach einem Seitenwechsel
                    identifiziert werden kann.
                  </Body>
                  <Body>
                    Dies erfolgt nicht durch eine Zuordnung zu Ihnen persönlich,
                    sondern durch Zuweisung einer Identifikationsnummer zu dem
                    Cookie („Cookie-ID“). Eine Zusammenführung der Cookie-ID mit
                    Ihrem Namen, Ihrer IP-Adresse oder mit ähnlichen Daten, die
                    eine Zuordnung des Cookies zu Ihnen ermöglichen würden,
                    erfolgt nicht.
                  </Body>
                  <Body>
                  ...
                  <Body className='italic underline'>
                    ...
                    mit der sich verschiedene Anfragen Ihres Browsers der
                    gemeinsamen Sitzung zuordnen lassen. Wenn Sie auf unsere
                    Website zurückkehren, kann Ihr Rechner wiedererkannt werden.
                  ...
                  <Body>
                    ...
                    aufrufende Browser auch nach einem Seitenwechsel
                    identifiziert werden kann. Für diese ist es erforderlich,
                  ...
                  <Body>
                    ...
                    Internetbrowser können Sie diesen so einstellen, dass
                    Cookies gar nicht gespeichert oder am Ende Ihrer
                    Internetsitzung automatisch gelöscht werden. Hierzu wählen
                    sie in den Einstellungen Ihres Browsers „keine Cookies
                    akzeptieren“. Im Microsoft Internet-Explorer wählen Sie
                    hierzu „Extras &gt; Internetoptionen &gt; Datenschutz &gt;
                    Einstellung“; In Firefox wählen Sie „Extras &gt;
                    Einstellungen &gt; Datenschutz &gt; Cookies“); Wenn Sie
                    einen anderen Internet-Browser verwenden, dann entnehmen Sie
                    bitte der Hilfefunktion des Browser die Anweisungen
                  ...
                  <Body>
                    Google analysiert in unserem Auftrag Ihre Nutzung unserer
                    Website. Hierfür verwenden wir u.a. Cookies. Was Cookies
                    sind und wie diese gelöscht werden können, haben wir oben im
                    Kapitel „Cookies“ beschrieben.
                  </Body>
                  <Body>
                    Die dabei von Google erhobenen Informationen über Ihre
                    Nutzung dieser Website (z.B. die bei uns besuchte Seiten)
                    werden an einen Server von Google in die USA übertragen,
                    dort gespeichert, analysiert und das Ergebnis uns in
                  ...
                  <Body>
                    ...
                    die Aktivitäten innerhalb unserer Website zusammenzustellen.
                    Dies ermöglicht uns Ihre Online-Erfahrung besser zu
                  ...
                  <Body>
                    ...
                    Minuten ohne Aktivität und Kampagnen nach sechs Monaten
                  ...
                  <Body>
                    ...
                    ihrer Browser-Software verhindern, wie oben im Kapitel
                    „cookies“ beschrieben. Sie können darüber hinaus die
                    Erfassung der durch das Cookie erzeugten und auf ihre
                    Nutzung unserer Website bezogenen Daten an Google sowie die
                    Verarbeitung dieser Daten durch Google verhindern, indem sie
                    das verfügbare Browser-Plugin von Google herunterladen und
                    installieren:{' '}
                  ...
                  <Body>
                    ...
                    Analytics beim Besuch unserer Webseite über verschiedene
                    Geräte (insbesondere mobile Geräte wie Smartphones oder
                    Tablets) verhindern möchten, müssen Sie das Opt-Out auf
                    allen genutzten Systemen durchführen. Wenn Sie hier klicken,
                    wird dieses Opt-Out-Cookie gesetzt.
                  </Body>
                  <Body>
                    Bitte beachten Sie, dass dieses Opt-Out-Cookie nur so lange
                    eine Webanalyse verhindert, wie sie es nicht gelöscht haben.
                    Weitere Informationen zu Google Analytics erhalten Sie in
                    den Google Analytics Nutzungsbedingungen{' '}
                ...
                <section id='privacy-section-7'>
                  ...
                  <Body>
                    ...
                    Maßnahmen zur Sicherheit der Datenverarbeitung entsprechend
                    dem Stand der Technik. Damit stellen wir sicher, dass die
                    Vorschriften der Datenschutzgesetze, insbesondere der
                    Datenschutz-Grundverordnung, eingehalten werden und die
                    durch uns verarbeiteten Daten gegen Vernichtung, Verlust,
                    Veränderung und unberechtigte Zugriffe geschützt sind. Zu
                    diesen Sicherheitsmaßnahmen zählt auch die verschlüsselte
                    Übertragung von Daten zwischen Ihrem Browser und unseren
                    Servern. Bitte beachten Sie, dass die SSL-Verschlüsselung
                    bei über das Internet ausgeführten Übertragungen nur dann
                    aktiviert ist, wenn das Schlüsselsymbol in der unteren
                    Menüleiste Ihres Browserfensters erscheint und die Adresse
                    mit https:// beginnt. Durch SSL (Secure Socket Layer) wird
                    die Datenübertragung mit einer Verschlüsselungstechnologie
                    vor illegalem Datenzugriff Dritter geschützt. Sollte diese
                    Option nicht zur Verfügung stehen, können Sie sich auch
                    dafür entscheiden, bestimmte Daten nicht über das Internet
                    zu versenden.
                  </Body>
                  <Body>
                    Alle Informationen, die Sie an uns übermitteln, werden auf
                    unseren Servern in der Bundesrepublik Deutschland
                ...
                <section id='privacy-section-8'>
                  ...
                  <Body>
                    Eine Weitergabe von Daten an Dritte erfolgt nur im Rahmen
                    der gesetzlichen Vorgaben. Wir geben die Daten der Nutzer an
                    Dritte nur dann weiter, wenn dies z.B. auf Grundlage des
                    Art. 6 Abs. 1 lit. b) DSGVO für Vertragszwecke erforderlich
                    ist, wir dazu gesetzliche verpflichtet sind (Art. 6 Abs.1
                    lit. c) DSGVO oder auf Grundlage berechtigter Interessen
                    gem. Art. 6 Abs. 1 lit. f. DSGVO am wirtschaftlichen und
                    effektivem Betrieb unseres Geschäftsbetriebes.
                  </Body>
                  <Body>
                    Wir setzen im Rahmen einer Auftragsverarbeitung gem. Art. 28
                    DSGVO Subunternehmer für die Erbringung unserer Leistungen,
                    insbesondere für den Betrieb, die Wartung und das Hosting
                    der Website ein. Wir haben geeignete rechtliche Vorkehrungen
                    sowie entsprechende technische und organisatorische
                    Maßnahmen getroffen, um für den Schutz der personenbezogenen
                    Daten gemäß den einschlägigen gesetzlichen Vorschriften zu
                    sorgen.
                  </Body>
                  <Body>&nbsp;</Body>
                </section>
                <section id='privacy-section-9'>
                  ...
                  <Body>
                    Wir binden externe Dienste oder Inhalte auf unserer Website
                    ein. Dies erfolgt auf Grundlage unserer berechtigten
                    Interessen an der Analyse, Optimierung und wirtschaftlichen
                    Betrieb unsers Onlineangebots im Sinne des Art. 6 Abs. 1
                    lit. f) DSGVO.
                  </Body>
                  <Body>
                    Bei Verwendung eines solchen Dienstes oder der Anzeige
                    Inhalte Dritter werden aus technischen Gründen
                    Kommunikationsdaten wie z.B. Datum, Uhrzeit und IP-Adresse
                    zwischen Ihnen und dem jeweiligen Anbieter ausgetauscht.
                    Hierbei handelt es sich insbesondere um Ihre IP-Adresse, die
                    für die Darstellung von Inhalten in Ihrem Browser
                    erforderlich ist. Weitere Informationen über Zweck und
                    Umfang der Erhebung und Verarbeitung Ihrer Daten entnehmen
                    Sie daher bitte den Datenschutzhinweisen der jeweils
                    datenschutzrechtlich verantwortlichen Anbieter der von uns
                    eingebundenen Dienste bzw. Inhalte. Die nachfolgende
                    Aufzählung bietet eine Übersicht von Drittanbietern sowie
                    ihrer Inhalte und Links zu deren Datenschutzerklärungen, die
                    weitere Hinweise zur Verarbeitung von Daten und
                    Widerspruchsmöglichkeiten enthalten.
                  </Body>
                  <ul>
                    <li>
                      Google Maps zur Darstellung von Karten, Standorten und für
                      die Routenplanung. Angeboten von: Google Inc., 1600
                    ...
                    <li>
                      Google Tag Manager zur Verwaltung von Website-Tags über
                      eine Oberfläche (z.B. Google Analytics und weitere
                      Google-Marketing-Dienste). Angeboten von: Google Inc.,
                    ...
                    <li>
                      ...
                      Inc., 1 Hacker Way, Menlo Park, CA 94025, USA, bzw.
                      innerhalb der EU: Facebook Ireland Ltd., 4 Grand Canal
                      ...
                      , Hinweise / Widerspruch / Opt-Out-Möglichkeit:{' '}
                      <UnderlineLink href='https://facebook.com/business/help/651294705016616'>
                    ...
                    <li>
                      ...
                      Angeboten von Google inc, 1600 Amphitheatre Parkway,
                    ...
                    <li>
                      Vimeo zur Darstellung von Videos der Plattform Vimeo.
                      Angeboten von: Vimeo Inc., Attention: Legal Department,
                    ...
                    <li>
                      ...
                      Onlineformularen. Angeboten von Google Inc. 1600
                ...
                <section id='privacy-section-10'>
                  ...
                  <Body>
                    ...
                    Facebook, Twitter, Instagram, XING, Linkedin, Pinterest,
                    tumblr und Google+.
                  </Body>
                  <Body>
                    Wenn Sie unsere Seite besuchen, werden zunächst keine
                    personenbezogenen Daten an die Anbieter der Plug-ins
                    weitergegeben. Den Anbieter des Plug-ins erkennen Sie über
                    die Markierung auf dem Kasten über seinen Anfangsbuchstaben
                    oder das Logo. Wir eröffnen Ihnen die Möglichkeit, über den
                    Button direkt mit dem Anbieter des Plug-ins zu
                    kommunizieren. Nur wenn Sie auf das markierte Feld klicken
                    und es dadurch aktivieren, erhält der Plug-in-Anbieter die
                    Information, dass Sie die entsprechende Website unseres
                    Online-Angebots aufgerufen haben.
                  </Body>
                  <Body>
                    Durch die Aktivierung des Plug-ins werden personenbezogene
                    Daten von Ihnen an den jeweiligen Plug-in-Anbieter
                    übermittelt und dort (bei US-amerikanischen Anbietern in den
                    USA) gespeichert. Da der Plug-in-Anbieter die Datenerhebung
                    insbesondere über Cookies vornimmt, empfehlen wir Ihnen, vor
                    dem Klick auf den ausgegrauten Kasten über die
                    Sicherheitseinstellungen Ihres Browsers alle Cookies zu
                    löschen.
                  </Body>
                  <Body>
                    Wir haben weder Einfluss auf die erhobenen Daten und
                    Datenverarbeitungsvorgänge, noch sind uns der volle Umfang
                    der Datenerhebung, die Zwecke der Verarbeitung, die
                    Speicherfristen bekannt. Auch zur Löschung der erhobenen
                    Daten durch den Plug-in-Anbieter liegen uns keine
                    Informationen vor.
                  </Body>
                  <Body>
                    Der Plug-in-Anbieter speichert die über Sie erhobenen Daten
                    als Nutzungsprofile und nutzt diese für Zwecke der Werbung,
                    Marktforschung und/oder bedarfsgerechten Gestaltung seiner
                    Website. Eine solche Auswertung erfolgt insbesondere (auch
                    für nicht eingeloggte Nutzer) zur Darstellung von
                    bedarfsgerechter Werbung und um andere Nutzer des sozialen
                    Netzwerks über Ihre Aktivitäten auf unserer Website zu
                    informieren. Ihnen steht ein Widerspruchsrecht gegen die
                    Bildung dieser Nutzerprofile zu, wobei Sie sich zur Ausübung
                    dessen an den jeweiligen Plug-in-Anbieter wenden müssen.
                    Über die Plug-ins bieten wir Ihnen die Möglichkeit, mit den
                    sozialen Netzwerken und anderen Nutzern zu interagieren, so
                    dass wir unser Angebot verbessern und für Sie als Nutzer
                    interessanter ausgestalten können. Rechtsgrundlage für die
                    Nutzung der Plug-ins ist Art. 6 Abs. 1 lit. f) DS-GVO.
                  </Body>
                  <Body>
                    Die Datenweitergabe erfolgt unabhängig davon, ob Sie ein
                    Konto bei dem Plug-in-Anbieter besitzen und dort eingeloggt
                    sind. Wenn Sie bei dem Plug-in-Anbieter eingeloggt sind,
                    werden Ihre bei uns erhobenen Daten direkt Ihrem beim
                    Plug-in-Anbieter bestehenden Konto zugeordnet. Wenn Sie den
                    aktivierten Button betätigen und z. B. die Seite verlinken,
                    speichert der Plug-in-Anbieter auch diese Information in
                    Ihrem Nutzerkonto und teilt sie Ihren Kontakten öffentlich
                    mit. Wir empfehlen Ihnen, sich nach Nutzung eines sozialen
                    Netzwerks regelmäßig auszuloggen, insbesondere jedoch vor
                    Aktivierung des Buttons, da Sie so eine Zuordnung zu Ihrem
                    Profil bei dem Plug-in-Anbieter vermeiden können.
                  </Body>
                  <Body>
                    Weitere Informationen zu Zweck und Umfang der Datenerhebung
                    und ihrer Verarbeitung durch den Plug-in-Anbieter erhalten
                    Sie in den im Folgenden mitgeteilten Datenschutzerklärungen
                    dieser Anbieter. Dort erhalten Sie auch weitere
                  ...
                  <ul>
                    <li>
                      ...
                      California 94304, USA. Datenschutzerklärung:{' '}
                ...
                <section id='privacy-section-11'>
                  ...
                  <Body>
                    Wenn wir personenbezogenen Daten von Ihnen verarbeiten, sind
                    Sie Betroffener i.S.d. Datenschutzgrundverordnung (DSGVO)
                    und Sie haben gegenüber uns folgende Rechte der Sie
                ...
                <section id='privacy-section-12'>
                  ...
                  <Body>
                    ...
                    Regelungen des Vertragsverhältnisses mit den Nutzern
                    enthalten, erfolgen die Änderungen nur mit Zustimmung der
                    Nutzer.
                  </Body>
                  <Body>
