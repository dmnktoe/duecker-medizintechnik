    ...
    <>
      <div className='flex w-full flex-row gap-6'>
          ...
          <div className='sticky top-navigation-height w-full bg-neutral-100'>
            <div className='px-4 py-8'>
              ...
              <ul className='list-none'>
                ...
                <li>
                  <UnderlineLink href='#begriffe'>
                    2. Erläuterungen der verwendeten Begriffe
                  </UnderlineLink>
                </li>
                <li>
                  <UnderlineLink href='#verantwortlicher'>
                    3. Name und Anschrift des Verantwortlichen
                  </UnderlineLink>
                </li>
                <li>
                  <UnderlineLink href='#datenschutzbeauftragter'>
                    4. Datenschutzbeauftragter
                  </UnderlineLink>
                </li>
                <li>
                  <UnderlineLink href='#minderjährige'>
                    5. Minderjährige
                  </UnderlineLink>
                </li>
                <li>
                  <UnderlineLink href='#datenverarbeitung'>
                    6. Verarbeitung personenbezogener Daten
                  </UnderlineLink>
                </li>
                <li>
                  <UnderlineLink href='#cookies'>7. Cookies</UnderlineLink>
                </li>
                <li>
                  <UnderlineLink href='#analyse'>
                    8. Analyse Tools
                  </UnderlineLink>
                </li>
                <li>
                  <UnderlineLink href='#socialmedia'>
                    9. Social Media Plugins
                  </UnderlineLink>
                </li>
                <li>
                  <UnderlineLink href='#rechte'>
                    10. Rechte der Nutzer
                  </UnderlineLink>
                </li>
                <li>
                  <UnderlineLink href='#loeschung'>
                    11. Löschung von Daten
                  </UnderlineLink>
                </li>
                <li>
                  <UnderlineLink href='#aenderungen'>
        ...
        <div className='w-full lg:w-9/12'>
          ...
          >
            <Title renderAs='h4' size='five' id='geltungsbereich'>
              1. Geltungsbereich
            </Title>
            <Body>
            ...
            <Body>Diese Website nutzt transiente und persistente Cookies.</Body>
            <Body>
